...
export class ProjetService {
  ...
  initProjets():void{
      this.projets = [
        new Projet(
          "Site web personnel",
          "Création de mon site web personnel servant de vitrine pour mes réalisations. Ce site, sur lequel vous naviguez actuellement, a été entièrement développé avec Angular. Il intègre la bibliothèque EmailJS, permettant de m'envoyer directement des emails depuis le site web.",
